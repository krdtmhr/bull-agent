...
class Portfolio:
    ...
    def load(self) -> "Portfolio":
        ...
        self.last_sell_parts = data.get("last_sell_parts", 0)
        return self
    ...
    def save(self):
        ...
        data = {
            ...
            "last_sell_parts": self.last_sell_parts,
        }
    ...
    def parts_used(self) -> int:
        ls = self.lot_size()
        return int(self.current_position_value / ls) if ls > 0 else 0
