...
- [x] 市場データ自動取得
  - 日経225・S&P500・NASDAQ・USD/JPY・CME先物
  - VIX（恐怖指数）：20以下=安定 / 25超=警戒 / 30超=危険
  - 米国10年債利回り：金利の上下方向を表示
  - ダウ平均は削除（S&P500と重複のため）
- [x] ルールベースシグナル生成（通常¥10,000 / 大変動¥30,000〜50,000）
  - VIX >= 25 で確信度 -0.15、VIX >= 30 で確信度 -0.25 の自動補正あり
